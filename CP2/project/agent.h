...
typedef struct _Player{
    ...
    int32_t (*pick)(struct _Player *player, const int32_t table[4][5], int32_t (*input)(int32_t *target, int8_t mode));
    int32_t (*choose)(struct _Player *player, const int32_t table[4][5], int32_t (*input)(int32_t *target, int8_t mode));
}Player;
